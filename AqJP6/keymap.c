...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_APPLICATION, 
    KC_LEFT_CTRL,   KC_LEFT_CTRL,   KC_LEFT_GUI,    KC_LEFT_ALT,    CW_TOGG,        LT(2, KC_SPACE),                                                                                                LT(3, KC_ENTER),CW_TOGG,        KC_LEFT_ALT,    KC_LEFT_GUI,    KC_LEFT_CTRL,   TT(4),          
