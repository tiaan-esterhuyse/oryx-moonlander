...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_LEFT_CTRL,   KC_LEFT_ALT,    TD(DANCE_0),                    KC_DELETE,      KC_LEFT_ALT,    KC_LEFT_CTRL
  ),
  [1] = LAYOUT_moonlander(
